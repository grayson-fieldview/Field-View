    ...
    html: `
      <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 560px; margin: 0 auto; padding: 40px 20px; color: #111;">
        ...
        <p style="margin-bottom: 24px;">
          <a href="${resetUrl}" style="background: #F09000; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; display: inline-block; font-weight: 600;">
            Reset password
          </a>
        </p>
  ...
  const { data, error } = await resend.emails.send({
    ...
    html: `
      <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 560px; margin: 0 auto; padding: 40px 20px; color: #111;">
        ...
        <p style="font-size: 16px; line-height: 1.5; margin-bottom: 24px;">
          ${greeting}<br><br>Enter the code below to verify your email address and finish setting up your Field View account.
        </p>
  ...
  const { data, error } = await resend.emails.send({
    ...
    html: `
      <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 560px; margin: 0 auto; padding: 40px 20px; color: #111;">
        ...
        <p style="margin-bottom: 24px;">
          <a href="${signInUrl}" style="background: #F09000; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; display: inline-block; font-weight: 600;">
            Sign in to restore
          </a>
        </p>
        <p style="font-size: 14px; color: #666; line-height: 1.5;">
